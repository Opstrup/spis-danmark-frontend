 ...
 *
 * @description
 * A services for testing barcode scanner features
 ...
 *
 * @description
 * A services for testing camera features
 * in an app build with ngCordova.
 **/
 ...
 *
 * @description
 * A services for testing media capture
 * in an app build with ngCordova.
 *
 * @example
 */
 ...
 *
 * @description
 * A services for testing features related with contacts
 * in an app build with ngCordova.
 **/
 ...
 *
 * @description
 * A services for testing datepicker features
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing device information
 * in an app build with ngCordova.
 **/
 ...
 *
 * @description
 * A services for mocking the accelerometer
 * in an app build with ngCordova.
 **/
 ...
 *
 * @description
 * A services for testing compass fetures
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing dialogs
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing Facebook features
 ...
 *
 * @description
 * A services for testing interaction with device directories and files
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing fileOpener2
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing download and upload
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing location services
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing features related to a user's locale and timezone.
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing google analytics services
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing Google Play Game features
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing device keyboard features
 * in an app build with ngCordova.
 **/
 ...
 *
 * @description
 * A services for testing Keychain features
 * in an app built with ngCordova.
 **/
 ...
 *
 * @description
 * A services for testing LocalNotificatio
 ...
 *
 * @description
 * A services for testing networked fetures
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing push notifications features
 * in an app build with ngCordova.
 */
ngCordovaMocks.factory('$cordovaPush', ['$q', '$timeout', '$rootScope', function ($q, $timeout, $rootScope) {
  ...
  return {
     ...
     *
     * @description
     * Token send when services register device
     * This property should only be used in automated tests.
     **/
 ...
 *
 * @description
 * A services for testing via social services
 * in an app build with ngCordova.
 */
ngCordovaMocks.factory('$cordovaSocialSharing', ['$q', function ($q) {
  ...
  return {
     ...
     *
     * @description
     * The message to be shared via a social services.
     * This property should only be used in automated tests.
     **/
    message: message,
     ...
     *
     * @description
     * An image to be shared via a social services.
     * This property should only be used in automated tests.
     **/
    image: image,
     ...
     *
     * @description
     * A link to be shared via a social services.
     * This property should only be used in automated tests.
     **/
    link: link,
     ...
     *
     * @description
     * The name of a social services to share content through.
     * This property should only be used in automated tests.
     **/
 ...
 *
 * @description
 * A services for testing the splash screen
 * in an app build with ngCordova.
 */
 ...
 *
 * @description
 * A services for testing the status bar
 * in an app build with ngCordova.
 */
ngCordovaMocks.factory('$cordovaStatusbar', function () {
  ...
  return {
     ...
     *
     * @description
     * A flag that signals whether the status bar can overlay the web templates.
     * This property should only be used in automated tests.
     **/
 ...
 *
 * @description
 * A services for testing vibration
 * in an app build with ngCordova.
 */
