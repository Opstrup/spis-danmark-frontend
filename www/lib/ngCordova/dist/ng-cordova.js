...
angular.module('ngCordova.plugins.cardIO', [])
  ...
  '$cordovaNgCardIO', [function () {
    ...
    /**
     * Function scanCard for $cordovaNgCardIO services to make scan of card
     *
     */
    this.$get = ['$q', function ($q) {
      return {
...
angular.module("oauth.providers", ["oauth.utils"])
    .factory("$cordovaOauth", ["$q", '$http', "$cordovaOauthUtility", function($q, $http, $cordovaOauthUtility) {
        ...
        return {
            ...
            /*
             * Sign into the ADFS services (ADFS 3.0 onwards)
			 *
             * @param    string clientId (client registered in ADFS, with redirect_uri configured to: http://localhost/callback)
            ...
            /*
             * Sign into the Dropbox services
             *
             * @param    string appKey
            ...
            /*
             * Sign into the Digital Ocean services
             *
            ...
            /*
             * Sign into the Facebook services
             *
             * @param    string clientId
             * @param    array appScope
             * @param    object options
            ...
            /*
             * Sign into the LinkedIn services
             *
             * @param    string clientId
             * @param    string clientSecret
             * @param    array appScope
            ...
            /*
             * Sign into the Instagram services
             *
             * @param    string clientId
             * @param    array appScope
             * @param    object options
            ...
            /*
             * Sign into the Twitter services
             * Note that this services requires jsSHA for generating HMAC-SHA1 Oauth 1.0 signatures
             *
             * @param    string clientId
             * @param    string clientSecret
             * @return   promise
            ...
            */
            ...
            /*
             * Sign into the Salesforce services
             *
            ...
            */
            ...
            /*
             * Sign into the Withings services
             * Note that this services requires jsSHA for generating HMAC-SHA1 Oauth 1.0 signatures
             *
             * @param    string clientId
             * @param    string clientSecret
            ...
            /*
            * Sign into the Foursquare services
            *
            * @param    string clientId
            * @param    object options
            * @return   promise
            */
            ...
            /*
            * Sign into the Magento services
            * Note that this services requires jsSHA for generating HMAC-SHA1 Oauth 1.0 signatures
            *
            ...
            */
            ...
            /*
             * Sign into the Vkontakte services
             *
             * @param    string clientId
			...
			/*
            * Sign into the Odnoklassniki services
            *
            * @param    string clientId
            ...
            */
            ...
            /*
             * Sign into the Spotify services
             *
             * @param    string clientId
             * @param    object options
             * @return   promise
            ...
            /*
             * Sign into the Windows Live Connect services
             *
             * @param    string clientId
             * @param    array appScope
             * @param    object options
            ...
            */
            ...
            /*
             * Sign into the FamilySearch services
             *
             * @param    string clientId
             * @param    object options
             * @return   promise
            ...
            /*
             * Sign into the Jawbone services
             *
             * @param    string clientId
             * @param    string clientSecret
             * @param    string appScope
            ...
            /*
            * Sign into the Untappd services
            *
            * @param    string clientId
            * @param    object options
            * @return   promise
            */
            ...
            /*
             * Sign into the Dribble services
             *
